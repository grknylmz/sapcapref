		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#InteractionInterface-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"InteractionInterface-display": {
								"semanticObject": "InteractionInterface",
								"action": "display",
								"description": "Web interface for the Interaction app of the NodeCapXSA project",
								"title": "Interaction Interface",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app.interaction.web",
									"url": sap.ui.require.toUrl("app/interaction/web")
								}
							}
						}
					}
